...
{
	std::cout << "ClapTrap name parametric constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string name, int hp, int ep, int a): _name(name), _hpoint(hp), _epoint(ep), _attack(a)
{
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (this->_hpoint < 0)
		this->_hpoint = 0;
	std::cout << "ClapTrap " << this->_name << " has " << this->_hpoint << " hit points left" << std::endl;
}
